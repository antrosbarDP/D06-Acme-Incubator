...
<acme:list readonly="false">
	...
	<acme:list-column code="authenticated.tool-record.list.label.inventor" path="inventor" width="20%" />
	<acme:list-column code="authenticated.tool-record.list.label.activitySector" path="activitySector" width="20%" />
	<acme:list-column code="authenticated.tool-record.list.label.stars" path="stars" width="40%" />
</acme:list>